...
Find my latest resume [here](http://shorturl.at/nxBQX).

## Activities & Projects
- [Blog Project](http://ajaxdapp.xyz/) - Repo coming soon :hourglass_flowing_sand:
- [Hackathon](https://devpost.com/software/banking-application) - :trophy: 1st Place winner Banking app created after my first class in C++.
